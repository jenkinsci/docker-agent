...
$builds = @{
    ...
    #'nanoserver' = @{ 'Dockerfile' = 'Dockerfile-windows-nanoserver' ; 'BuildArgs' = '' };
    #'nanoserver-jdk11' = @{ 'Dockerfile' = 'Dockerfile-windows-nanoserver' ; 'BuildArgs' = '--build-arg `"JAVA_BASE_VERSION=11`" --build-arg "JAVA_VERSION=11.0.3-1" --build-arg "JAVA_ZIP_VERSION=11.0.3.7-1" --build-arg "JAVA_SHA256=b13703a7ee5ff3e14881b7d3488fa93942d1858ca3cd5fa9234b763df84dc937"' };
}
